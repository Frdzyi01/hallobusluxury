...
@section('Title-Sub', 'Detail - Big Bus 50 Seat (2-2)')
@section('content')
        ...
        <div class="container">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="shop-single-slider">
                        <div class="slider-for">
                            ...
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/Bigbus-standart-50-seat( 2-2 )/2.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/Bigbus-standart-50-seat( 2-2 )/3.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/Bigbus-standart-50-seat( 2-2 )/4.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/Bigbus-standart-50-seat( 2-2 )/k5.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/Bigbus-standart-50-seat( 2-2 )/6.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/Bigbus-standart-50-seat( 2-2 )/7.png') }}"
                                    alt="Interior Bus" />
                            </div>
                        </div>
            ...
            <div class="col col-lg-6 col-12">
                <div class="product-details">
                    ...
                    <p>
                        Big Bus 50 Seat (2 -2) Executive merupakan armada premium kami yang
