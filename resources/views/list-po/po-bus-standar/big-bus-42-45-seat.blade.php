                        ...
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3><a
                                        ...
                                        Sinar Jaya - Big Bus 42 - 45 Seat</a></h3>
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-medium-30seact/busmedium30seat.jpg') }}"
                                    alt="PO Putra Tidar - Big Bus 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3> <a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-42-45-seat.detail-big-bus-42-45seat-putra-tidar') }}">PO
                                        Putra Tidar - Big Bus 42 - 45 Seat</a></h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bhaladika/mediumbus-31seat.png') }}"
                                    alt="PO Bhaladika - Big Bus 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-42-45-seat.detail-big-bus-42-45seat-bhaladika') }}">PO
                                        Bhaladika - Big Bus 42 - 45 Seat</a></h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/white-horse/mediumbus-31seat.webp') }}"
                                    alt="PO White Horse - Big Bus 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-42-45-seat.detail-big-bus-42-45seat-white-horse') }}">PO
                                        White Horse - Big Bus 42 - 45 Seat</a></h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/BusBlueStar/mediumbus-31seat.png') }}"
                                    alt="Bus Blue Star - Big Bus 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/starbus/mediumbus-31seat.jpg') }}"
                                    alt="Bus Starbus - Big Bus 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-42-45-seat.detail-big-bus-42-45seat-starbus') }}">PO
                                        Bus Starbus - Big Bus 42 - 45 Seat</a>
                                </h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-bin-ilyas/mediumbus-31seat.png') }}"
                                    alt="Bus Bin Ilyas - Big Bus 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3> <a
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-rejeki-gemilang/mediumbus-31seat.png') }}"
                                    alt="Bus Rejeki Gemilang 42 - 45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            Å <div class="details">
                                <h3>
                                    <a
