...
@section('title', 'Big Bus 50 (2-2) Seat Putra Tidar - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus 50 (2-2) Seat Putra Tidar')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus 50 (2-2) Seat Putra Tidar </h2>
                        ...
                        <p>
                            Big Bus 50 (2-2) Seat Putra Tidar merupakan solusi transportasi
                    ...
                    <div class="product-info">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="Description">
                                <p>
                                    Big Bus 50 (2-2) Seat Executive dirancang khusus untuk
