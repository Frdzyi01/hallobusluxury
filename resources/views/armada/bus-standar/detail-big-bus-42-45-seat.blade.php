...
@section('Title-Sub', 'Detail - Big Bus 42-45 Seat')
@section('content')
        ...
        <div class="container">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="shop-single-slider">
                        <div class="slider-for">
                            ...
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/bigbus-42-45seat/2.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/bigbus-42-45seat/3.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/bigbus-42-45seat/4.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/bigbus-42-45seat/1.png') }}"
            ...
            <div class="col col-lg-6 col-12">
                <div class="product-details">
                    ...
                    <p>
                        Big Bus 42 - 45 Seat Executive merupakan armada premium kami yang
                        ...
                        , dispenser
                        , toilet
                        , smoking room untuk perjalanan jarak jauh. Ideal untuk
