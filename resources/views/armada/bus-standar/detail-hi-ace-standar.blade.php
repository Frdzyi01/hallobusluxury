...
@section('Title-Sub', 'Detail - Hiace Standar')
@section('content')
                ...
                <div class="col col-lg-6 col-12">
                    <div class="shop-single-slider">
                        <div class="slider-for">
                            ...
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/hiace-standar/2.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/hiace-standar/3.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/hiace-standar/4.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/hiace-standar/5.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/hiace-standar/6.png') }}"
                                    alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bus-standar-baru/hiace-standar/7.png') }}"
                                    alt="Interior Bus" />
                            </div>
                        </div>
