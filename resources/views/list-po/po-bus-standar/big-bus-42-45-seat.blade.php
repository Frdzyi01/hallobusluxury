...
@section('title', 'List PO Big Bus 42-45 Seat - HalloBus Luxury')


@section('Title-Head', 'Armada Kami')
@section('Title-Sub', 'List List PO Big Bus 42-45 Seat')
@section('content')
                ...
                <div class="col col-xs-12">
                    <div class="shop-grids clearfix">
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Sinar Jaya - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Sinar Jaya - Big Bus 42 -45 Seat</a></h3>
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Lorena - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3>
                                    <a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Lorena - Big Bus 42-45 Seat</a>
                                </h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Haryanto - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Haryanto - Big Bus 42-45 Seat</a>
                                </h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Rosalia Indah - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Rosalia Indah - Big Bus 42 -45 Seat</a></h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Sumber Selamat - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Sumber Selamat - Big Bus 42 -45 Seat</a></h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Eka - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Eka - Big Bus 42-45 Seat</a>
                                </h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Sugeng Rahayu - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3> <a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Sugeng Rahayu - Big Bus 42 -45 Seat</a></h3>
                                <p class="deskripsi-bus">
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus/pariwisata.png') }}"
                                    alt="PO Handoyo - Big Bus 42-45 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3> <a href="{{ route('bus.standar.medium-bus-31seat') }}">PO Handoyo - Big Bus 42 -45 Seat</a></h3>
                                <p class="deskripsi-bus">
