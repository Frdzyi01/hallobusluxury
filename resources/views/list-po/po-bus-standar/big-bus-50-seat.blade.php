                ...
                <div class="col col-xs-12">
                    <div class="shop-grids clearfix">
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-50-seat.detail-big-bus-50seat-sinar-jaya') }}">PO
                                        Sinar Jaya - Big Bus 50 Seat</a></h3>
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-50-seat.detail-big-bus-50seat-sinar-jaya') }}"
                                        style="
