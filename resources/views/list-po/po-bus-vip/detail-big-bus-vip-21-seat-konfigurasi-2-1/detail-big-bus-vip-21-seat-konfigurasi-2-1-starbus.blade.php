...
@section('title', 'Big Bus VIP 21 Seat Konfigurasi (2-1) Starbus - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus VIP 21 Seat Konfigurasi (2-1) Starbus')
@section('content')
            ...
            <div class="row">
                <div class="col col-lg-6 col-12">
                    <div class="shop-single-slider">
                        <div class="slider-for">
                            <div>
                                <img src="{{ asset('barise/assets/images/starbus/mediumbus-31seat.jpg') }}" alt="Bus" />
                            </div>
                            <div>
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus VIP 21 Seat Konfigurasi (2-1) Starbus </h2>
                        ...
                        <p>
                            Big Bus VIP 21 Seat Konfigurasi (2-1) Starbus merupakan solusi transportasi
                        ...
                        <ul>
                            <li>PO: Bus Starbus</li>
                            <li>Kapasitas: 35 Seat Executive</li>
                    ...
                    <div class="product-info">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="Description">
                                <p>
                                    Big Bus VIP 21 Seat Konfigurasi (2-1) Executive dirancang khusus untuk
