...
@section('title', 'Medium Bus 31 Seat Bus Blue Star Bus - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Medium Bus 31 Seat Bus Blue Star Bus')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Medium Bus 31 Seat Bus Blue Star Bus </h2>
                        ...
                        <p>
                            Medium Bus 31 Seat Bus Blue Star Bus merupakan solusi transportasi
