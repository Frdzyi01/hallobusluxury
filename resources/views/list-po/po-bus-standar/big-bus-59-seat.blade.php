...
@section('title', 'List Po Big Bus 59 Seat - HalloBus Luxury')


@section('Title-Head', 'Armada Kami')
@section('Title-Sub', 'List List PO Big Bus 59 Seat')
@section('content')
                    ...
                    <div class="shop-grids clearfix">
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-sinar-jaya/medium-bus-31.png') }}"
                                    alt="PO Sinar Jaya - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-sinar-jaya') }}">PO
                                        Sinar Jaya - Big Bus 59 Seat</a></h3>
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-sinar-jaya') }}"
                                        style="
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-medium-30seact/busmedium30seat.jpg') }}"
                                    alt="PO Putra Tidar - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3> <a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-putra-tidar') }}">PO
                                        Putra Tidar - Big Bus 59
                                        Seat</a></h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-putra-tidar') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bhaladika/mediumbus-31seat.png') }}"
                                    alt="PO Bhaladika - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-bhaladika') }}">PO
                                        Bhaladika - Big Bus 59
                                        Seat</a></h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-bhaladika') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/white-horse/mediumbus-31seat.webp') }}"
                                    alt="PO White Horse - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-white-horse') }}">PO
                                        White Horse - Big Bus 59
                                        Seat</a></h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-white-horse') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/BusBlueStar/mediumbus-31seat.png') }}"
                                    alt="Bus Blue Star - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-blue-star') }}">Bus
                                        Blue Star - Big Bus
                                        59 Seat</a></h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-blue-star') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/starbus/mediumbus-31seat.jpg') }}"
                                    alt="Bus Starbus - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3><a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-starbus') }}">PO
                                        Bus Starbus - Big Bus 59
                                        Seat</a>
                                </h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-starbus') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-bin-ilyas/mediumbus-31seat.png') }}"
                                    alt="Bus Bin Ilyas - Big Bus 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            <div class="details">
                                <h3> <a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-bin-ilyas') }}">Bus
                                        Bin Ilyas - Big Bus
                                        59 Seat</a></h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-bin-ilyas') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3>
                                    <a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-big-bird') }}">Bus
                                        Big Bird - Medium Bu 59 Seat</a>
                                </h3>
                                <p class="deskripsi-bus">
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-big-bird') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
                        ...
                        <div class="grid">
                            <div class="img-holder">
                                <img src="{{ asset('barise/assets/images/bus-rejeki-gemilang/mediumbus-31seat.png') }}"
                                    alt="Bus Rejeki Gemilang 59 Seat" style="height: 280px; object-fit: cover" />
                            </div>
                            Å <div class="details">
                                <h3>
                                    <a
                                        href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-rejeki-gemilang') }}">PO
                                ...
                                <div class="add-to-cart">
                                    <a href="{{ route('list-po.po-bus-standar.detail-big-bus-59-seat.detail-big-bus-59seat-rejeki-gemilang') }}"
                                        style="
                                    display: inline-block;
                                    padding: 8px 15px;
                                    background: #f5f5f5;
