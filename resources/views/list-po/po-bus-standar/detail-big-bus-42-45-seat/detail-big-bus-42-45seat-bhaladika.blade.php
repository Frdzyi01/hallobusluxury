...
@section('title', 'Big Bus 42 -45 Seat Bus Bhaladika - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus 42 -45 Seat Bus Bhaladika')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus 42 -45 Seat Bus Bhaladika </h2>
                        ...
                        <p>
                            Big Bus 42 -45 Seat Bus Bhaladika merupakan solusi transportasi
