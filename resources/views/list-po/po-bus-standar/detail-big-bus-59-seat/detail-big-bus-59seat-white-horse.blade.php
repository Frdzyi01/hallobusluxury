...
@section('title', 'Big Bus 59 Seat White Horse - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus 59 Seat White Horse')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus 59 Seat White Horse </h2>
                        ...
                        <p>
                            Big Bus 59 Seat White Horse merupakan solusi transportasi
