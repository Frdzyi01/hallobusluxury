...
@section('title', 'Big Bus Luxury 45 Seat Rejeki Gemilang - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus Luxury 45 Seat Rejeki Gemilang')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus Luxury 45 Seat Rejeki Gemilang </h2>
                        ...
                        <p>
                            Big Bus Luxury 45 Seat Rejeki Gemilang merupakan solusi transportasi
