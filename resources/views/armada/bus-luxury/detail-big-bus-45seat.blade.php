...
@section('title', 'Detail Big Bus 45 Seat - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus 45 Seat')
@section('content')
                ...
                <div class="col col-lg-6 col-12">
                    <div class="shop-single-slider">
                        <div class="slider-for">
                            <div>
                                <img src="{{ asset('barise/assets/images/bigbus45seat/1.png') }}" alt="Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bigbus45seat/2.png') }}" alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bigbus45seat/3.png') }}" alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bigbus45seat/4.png') }}" alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bigbus45seat/5.png') }}" alt="Interior Bus" />
                            </div>
                            <div>
                                <img src="{{ asset('barise/assets/images/bigbus45seat/6.png') }}" alt="Interior Bus" />
                            </div>
                        </div>
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        ...
                        <p>
                            ...
                            dual AC, toilet modern, dan kursi reclining ergonomis yang
                            nyaman untuk perjalanan jarak jauh. Cocok untuk wisata
                            keluarga, perjalanan dinas, atau rombongan grup.
                        </p>

                        <ul>
                            <li>Kapasitas: 45 Seat Deluxe</li>
                            <li>Tipe Mesin: OM 457 LA Euro 4</li>
                    ...
                    <div class="product-info">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="Description">
                                <p>
                                    Bus 45 Seat Deluxe merupakan solusi transportasi nyaman
                                    dengan kapasitas optimal 45 seat. Dirancang khusus untuk
                                    memberikan kenyamanan maksimal dengan konfigurasi seat 2-2
                                    yang lapang dan legroom ekstra. Dilengkapi dengan
                                    fasilitas modern untuk mendukung perjalanan jarak jauh
                                    yang menyenangkan.
                                </p>
                                ...
                                <p>
                                    ...
                                    dengan sistem hiburan onboard, WiFi stabil, dan charging
                                    port di setiap kursi. Pengemudi profesional kami telah
                                    berpengalaman melayani berbagai kebutuhan perjalanan grup.
                                </p>
                            </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="features">
                                <ul class="list list-mark-2 list-ervices">
                                    ...
                                    <li>Kursi reclining deluxe dengan sandaran kepala</li>
                                    <li>Sistem audio dan video onboard</li>
                                    <li>Toilet modern dengan wastafel</li>
                                    <li>WiFi gratis selama perjalanan</li>
                                    <li>Stop kontak USB di setiap kursi</li>
                                    <li>Bagasi luas dengan kapasitas 4 m³</li>
                                    ...
                                    <li>Driver berpengalaman + asisten</li>
                                    ...
                                    <div class="col col-lg-10 col-12">
                                        <div class="client-rv">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="review-body">
                                                    <p>
                                                        Bus sangat nyaman untuk perjalanan rombongan
                                                        kantor kami. AC bekerja dengan baik, kursi empuk
                                                        dan legroom cukup luas. Sopir sangat profesional
                                                        dan membantu. Hanya saja WiFi kadang kurang
                                                        stabil di beberapa area.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="client-rv">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="review-body">
                                                    <p>
                                                        Cocok untuk wisata keluarga kami. Toilet bersih
                                                        dan terawat. Kursi nyaman untuk perjalanan 6
                                                        jam. Hanya sedikit kecewa dengan space bagasi
                                                        yang agak terbatas untuk rombongan kami. Tapi
