...
@section('title', 'Big Bus VIP 21 Seat Konfigurasi (2-1) White Horse - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus VIP 21 Seat Konfigurasi (2-1) White Horse')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus VIP 21 Seat Konfigurasi (2-1) White Horse </h2>
                        ...
                        <p>
                            Big Bus VIP 21 Seat Konfigurasi (2-1) White Horse merupakan solusi transportasi
