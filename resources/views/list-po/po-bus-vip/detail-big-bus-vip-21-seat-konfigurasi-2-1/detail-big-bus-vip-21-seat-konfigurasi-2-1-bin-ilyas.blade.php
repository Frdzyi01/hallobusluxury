...
@section('title', 'Big Bus VIP 21 Seat Konfigurasi (2-1) Bus Bin Ilyas - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Big Bus VIP 21 Seat Konfigurasi (2-1) Bus Bin Ilyas')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Big Bus VIP 21 Seat Konfigurasi (2-1) Bus Bin Ilyas </h2>
                        ...
                        <p>
                            Big Bus VIP 21 Seat Konfigurasi (2-1) Bus Bin Ilyas merupakan solusi transportasi
