                ...
                <div class="container">
                    <div class="row align-items-center">
                      ...
                      />putratidartrans@gmail.com
                                    ...
                                    <li>
                                        <img src="{{ asset('barise/assets/images/location.png') }}"
                                            alt="" />Jl.
            ...
            <div class="container-fluid carousel-left">
                <div class="choose-slider owl-carousel">
                    <div class="card-single">
                        <div class="image">
                            ...
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('barise/assets/images/property/1.svg') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('barise/assets/images/property/2.svg') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('barise/assets/images/property/3.svg') }}"
                                            alt="" />
                                    </div>
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('barise/assets/images/property/4.svg') }}"
                                            alt="" />
                                    </div>
                    ...
                    <div class="card-single">
                        <div class="image">
                            <img src="{{ asset('barise/assets/images/BigbusVIP28-30Seat/home.jpeg') }}"
                                alt="Bus VIP" style="width: 530px; height: 590px; object-fit: cover" />
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('barise/assets/images/property/1.svg') }}"
