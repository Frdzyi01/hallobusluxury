...
@section('title', 'Medium Bus 35 Seat Bus Big Bird - HalloBus Luxury')

@section('Title-Head', 'Detail Armada Kami')
@section('Title-Sub', 'Detail - Medium Bus 35 Seat Bus Big Bird')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col col-lg-6 col-12">
                    <div class="product-details">
                        <h2>Medium Bus 35 Seat Bus Big Bird </h2>
                        ...
                        <p>
                            Medium Bus 35 Seat Bus Big Bird merupakan solusi transportasi
